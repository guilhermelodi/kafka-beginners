package com.github.guilhermelodikafka;
...
public class StreamsFilterTweets {
    ...
    private final Logger log = LoggerFactory.getLogger(StreamsFilterTweets.class);

    public static void main(String[] args) {
        final String BOOTSTRAP_SERVER = "localhost:9092";
        final String APPLICATION_ID = "demo-kafka-streams";
